...
<section id="pricing" style="margin-top:46px">
...
<script>function gotoTry(){var t=document.getElementById("try");if(t){t.scrollIntoView({behavior:"smooth"});}}</script>
