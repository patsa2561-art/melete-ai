...
export function socialMeta(o: { title: string; desc: string; path: string; img: string }): string {
  ...
  return `<meta property="og:type" content="website"><meta property="og:site_name" content="Melete">`
    ...
    + `<meta property="og:url" content="${url}"><meta property="og:image" content="${img}"><meta property="og:image:type" content="image/svg+xml"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630">`
...
${socialMeta({ title: "Melete for " + en.name + " — " + en.h, desc: en.sub, path: "/for/" + key, img: "/og/" + key + ".svg" })}${faviconLinks()}${structuredData("/for/" + key, "Melete for " + en.name, en.h, { breadcrumb: [{ name: "Home", url: "/" }, { name: en.name, url: "/for/" + key }] })}
