...
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรอง Anytime-Valid (e-value)':'ANYTIME-VALID CERTIFICATE (e-value)'),(th?'แอบดูได้ตลอด การรับประกัน error ยังอยู่ — สิ่งที่ LLM ทำไม่ได้':'peek as often as you like, the guarantee holds — an LLM cannot'),body,(th?'พิสูจน์แล้ว: ใต้ null + optional stopping เตือนผิด ≤ α (วัด 2.4%) · naive peek พุ่งเป็น 42% (18×) · gain จริงตรวจเจอ 91% หยุดเฉลี่ย peek 84/200 · เซ็น Ed25519 · ต่างจาก R10 (anytime ไม่จำกัดจำนวน peek)':'proven: under null + optional stopping FP ≤ α (measured 2.4%) · naive peeking 42% (18×) · real gain detected 91% stopping at peek 84/200 · Ed25519-signed · stronger than fixed-look sequential (valid under UNLIMITED peeks)'));}
