...
+'<div style="display:flex;align-items:center;gap:11px;margin-bottom:3px"><span style="font-size:25px">'+D.ic+'</span><span style="font-size:18px;font-weight:800;color:'+D.col+'">'+D.t+'</span></div>'
