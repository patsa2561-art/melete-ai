...
<section id="flab" style="margin-top:30px">
  <div class="eyebrow" data-i18n="flabEye">FRONTIER LAB · THE HONESTY STACK · 14 SIGNED CERTIFICATES</div>
  <h2 data-i18n="flabH">14 ways an optimizer can mislead you — each caught by a signed, offline-verifiable certificate</h2>
...
<section class="ps">
  ...
  <div class="price">
    ...
    <div class="tier reveal"><div class="tn">Acquisition</div><div class="tp">Acquire</div><div class="tps">the code + the namespace</div><ul><li>Dependency-free TypeScript, 65 modules</li><li>Transfers repo + <code>melete-ai</code> npm</li><li>Live, tested, one-command deploy</li><li>The roadmap + this moat</li></ul><div class="ta"><a class="tb s" href="mailto:patsa2561@gmail.com?subject=Melete%20Acquisition">Make an offer →</a></div></div>
  </div>
