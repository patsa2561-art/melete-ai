...
+'</div><div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'gain เดียวกัน ใช้การวัดน้อยลง '+ratio+'× (แต่ละการวัด = เงิน/reagent)':'same gain, '+ratio+'× fewer measurements (each one = reagents / money)')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบพิสูจน์การปรับปรุง':'PROOF OF IMPROVEMENT'),(th?'รับรอง gain ด้วยการวัดน้อยลงหลายเท่า':'certify the gain from far fewer measurements'),body,(th?'พิสูจน์แล้ว: CRN ใช้การวัดน้อยลง ~8.8× · ขอบล่างถูกต้อง ≥97.5% · เซ็น Ed25519 · ของจริงจาก /improvement':'proven: CRN ~8.8× fewer measurements · lower bound valid ≥97.5% · Ed25519-signed · live from /improvement'));}
