...
<section class="ps">
  ...
  <div class="price">
    ...
    <div class="tier reveal"><div class="tn">Acquisition</div><div class="tp">Acquire</div><div class="tps">the code + the namespace</div><ul><li>Dependency-free TypeScript, 59 modules</li><li>Transfers repo + <code>melete-ai</code> npm</li><li>Live, tested, one-command deploy</li><li>The roadmap + this moat</li></ul><div class="ta"><a class="tb s" href="mailto:patsa2561@gmail.com?subject=Melete%20Acquisition">Make an offer →</a></div></div>
  </div>
