...
<section id="flab" style="margin-top:30px">
  <div class="eyebrow" data-i18n="flabEye">FRONTIER LAB · THE HONESTY STACK · 15 SIGNED CERTIFICATES</div>
  <h2 data-i18n="flabH">15 ways an optimizer can mislead you — each caught by a signed, offline-verifiable certificate</h2>
  <p style="max-width:820px;color:#475;font-size:15.5px;line-height:1.6" data-i18n="flabP">The honesty stack no other optimizer ships. Every button runs the REAL Melete engine on-box — numbers are live, not canned, and every verdict is Ed25519-signed so an auditor re-checks it offline. Press one.</p>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:14px;margin-top:18px">
    ...
    <div class="galcard" onclick="gStab()" style="--gc:#38bdf8"><div class="gtitle" data-i18n="flabStabT">🏔 Stability Certificate</div><div class="gknobs" data-i18n="flabStabD">Is the optimum reproducible, or a lucky one-off? Independent searches must agree. Proven: when it says STABLE, a held-out search reproduces it ≥97.5% — signed.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gHonest()" style="--gc:#facc15"><div class="gtitle" data-i18n="flabHonT">💎 Honest-Search Proof</div><div class="gknobs" data-i18n="flabHonD">Detect a FAKED optimization. A genuine search re-derives exactly; a forged trace is rejected — offline, no oracle needed. Something no LLM can do.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gTol()" style="--gc:#2dd4bf"><div class="gtitle" data-i18n="flabTolT">🛡 Tolerance Certificate</div><div class="gknobs" data-i18n="flabTolD">A certified ±tolerance: every setting within the radius keeps ≥90% of the optimum — Lipschitz-guaranteed (worst-case, not average), signed.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gImp()" style="--gc:#fb923c"><div class="gtitle" data-i18n="flabImpT">📜 Proof of Improvement</div><div class="gknobs" data-i18n="flabImpD">Certify B beats A by ≥Δ (noise-aware, signed) — and via common-random-numbers pairing, prove the same gain from ~8× fewer measurements.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gPre()" style="--gc:#c084fc"><div class="gtitle" data-i18n="flabPreT">🔐 Pre-Registration</div><div class="gknobs" data-i18n="flabPreD">Anti-cherry-picking: commit to the objective, space, budget &amp; rule BEFORE running — then prove the result obeyed it. Catches goalpost-moving an LLM can't.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gBreak()" style="--gc:#f59e0b"><div class="gtitle" data-i18n="flabBreakT">🪨 Decision-Breakdown</div><div class="gknobs" data-i18n="flabBreakD">How many corrupted measurements (fraud, a glitchy sensor) would it take to FLIP your "B beats A" verdict? The exact tamper-distance — a strong call survives many, a marginal one flips on one.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gSel()" style="--gc:#38bdf8"><div class="gtitle" data-i18n="flabSelT">📉 Winner&apos;s Curse</div><div class="gknobs" data-i18n="flabSelD">Search N settings, report the best — and that number is INFLATED (you picked the max of N noisy trials). The signed correction: the winner&apos;s TRUE value is ≥ this, after the optimism. The discount grows with N.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gSup()" style="--gc:#818cf8"><div class="gtitle" data-i18n="flabSupT">🧭 Extrapolation-Guard</div><div class="gknobs" data-i18n="flabSupD">Is the recommended setting INSIDE the data you measured, or a blind extrapolation? A beyond-the-box recommendation is flagged with a separating-axis WITNESS (an exact proof it is outside your evidence) — how you avoid melting the reactor.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gFdr()" style="--gc:#2dd4bf"><div class="gtitle" data-i18n="flabFdrT">📊 False-Discovery Control</div><div class="gknobs" data-i18n="flabFdrD">Report 40 findings at once and ~2 are pure luck, dressed up as real. Benjamini-Hochberg controls the fraction of your reported discoveries that are false — and drops the naive &quot;findings&quot; that do not survive.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gAny()" style="--gc:#facc15"><div class="gtitle" data-i18n="flabAnyT">⏱ Anytime-Valid (peek freely)</div><div class="gknobs" data-i18n="flabAnyD">An AI agent peeks after every experiment — and naive &quot;stop when p&lt;0.05&quot; then fires falsely ~40% of the time. The e-value test stays valid under unlimited peeking + optional stopping: stop whenever, the error guarantee holds.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gSwarm()" style="--gc:#22d3ee"><div class="gtitle" data-i18n="flabSwarmT">🤝 Swarm Evidence</div><div class="gknobs" data-i18n="flabSwarmD">Many AI agents, each with weak evidence, pool into ONE verdict stronger than any single one — and an agent that LIES (claims more than its data shows) is re-derived and excluded. Multi-agent trust, signed.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gConf()" style="--gc:#a3e635"><div class="gtitle" data-i18n="flabConfT">📏 Conformal Prediction</div><div class="gknobs" data-i18n="flabConfD">"ŷ ± 1.96σ" assumes Gaussian noise — wrong on real skewed/heavy-tailed data. Conformal gives a DISTRIBUTION-FREE interval with guaranteed coverage ≥ 1−α from any predictor, finite-sample exact, and tighter than the Gaussian when its assumption is wrong.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
    <div class="galcard" onclick="gMcp()" style="--gc:#f472b6"><div class="gtitle" data-i18n="flabMcpT">🔌 MCP — Trust Middleware</div><div class="gknobs" data-i18n="flabMcpD">Melete as the toll-booth of truth for AI agents: any agent (Claude / GPT / Gemini) calls it over the Model Context Protocol and gets back a SIGNED, offline-verifiable answer — not a number to take on faith. Plug-and-play.</div><div class="grun" data-i18n="flabRun">▶ run live</div></div>
  </div>
...
function gPre(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังตรวจ pre-registration…':'checking pre-registration…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/prereg',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:3})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastPre=j;renderPre(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderPre(j){var th=(LANG==='th');var col='#c084fc';
var panel=function(title,p,note){var ok=p.conforms;var c=ok?'#34d399':'#fb7185';return '<div style="flex:1;min-width:220px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:19px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'66">'+(ok?(th?'✓ ตรงตามที่ลงทะเบียน':'✓ CONFORMS'):(th?'✕ ปฏิเสธ':'✕ REJECTED'))+'</div><div style="font-size:12px;color:#cdd6ee;margin-top:7px;line-height:1.5">'+p.reason+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?'ผูก (hash) objective+space+budget+กติกาตัดสิน ก่อนรัน (commit #'+j.commitHash+'). หลังรัน พิสูจน์ offline ว่าผลทำตามที่ลงทะเบียน — จับการย้ายเป้า/เลือกผลสวย':'commit (hash) the objective + space + budget + decision rule BEFORE running (commit #'+j.commitHash+'). Afterwards, prove offline the result obeyed it — catching goalpost-moving / cherry-picking')+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel((th?'รันตามที่ลงทะเบียน':'a pre-registered run'),j.genuine,(th?'objective/space/budget/ผู้ชนะ ตรงหมด':'objective / space / budget / winner all match'))
+panel((th?'เลือกผลสวย (cherry-pick)':'a cherry-picked run'),j.cherryPicked,(th?'รายงานจุดที่ไม่ใช่ดีที่สุด → ถูกจับ':'reported a non-best point → caught'))
+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรอง Pre-Registration':'PRE-REGISTRATION CERTIFICATE'),(th?'พิสูจน์ว่าไม่ย้ายเป้า — สิ่งที่ LLM ทำไม่ได้':'proof you did not move the goalposts — an LLM cannot'),body,(th?'พิสูจน์แล้ว: 6 แบบการโกงโจทย์ถูกจับหมด · commit-reveal เซ็น Ed25519 · ของจริงจาก /prereg':'proven: 6 goalpost-moving deviations all caught · Ed25519 commit-reveal · live from /prereg'));}
function gBreak(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังคำนวณระยะทนการปลอมข้อมูล…':'computing the tamper-distance…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/breakdown',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastBreak=j;renderBreak(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderBreak(j){var th=(LANG==='th');var col='#f59e0b';
var panel=function(title,p,note){var robust=(p.verdict==='ROBUST');var c=robust?'#34d399':'#fb7185';var m=p.breakdown+(p.atLeast?'+':'');var wit='';if(p.witness&&p.witness.length){var moves=p.witness.slice(0,3).map(function(w){return (th?'จุด#':'#')+w.measurement+': '+w.from+'→'+w.to;}).join(' · ');wit='<div style="font-size:11px;color:#fbbf24;margin-top:8px;font-family:ui-monospace,monospace;line-height:1.5">'+(th?'การโจมตีที่พิสูจน์ได้: ':'the proven attack: ')+moves+'</div>';}return '<div style="flex:1;min-width:220px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:34px;font-weight:800;color:'+c+';text-shadow:0 0 16px '+c+'55;line-height:1">'+m+'</div><div style="font-size:11px;color:#8a98b8;margin-top:2px">'+(th?('การวัดที่ถูกปลอม จาก '+p.ofMeasurements+' จุด เพื่อพลิกผล'):('corrupted of '+p.ofMeasurements+' measurements would flip it'))+'</div><div style="font-size:15px;font-weight:800;color:'+c+';margin-top:9px">'+(robust?(th?'🪨 ทนทาน (ROBUST)':'🪨 ROBUST'):(th?'⚠ เปราะ (FRAGILE)':'⚠ FRAGILE'))+'</div>'+wit+'<div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?'การตัดสิน "B ดีกว่า A" วางอยู่บนการวัดจำนวนหนึ่ง. ต้องปลอม/ทำให้ผิดพลาดกี่จุด (ในช่วงค่าจริงที่สังเกตได้) ผลจึงพลิก? นี่คือระยะทนการปลอม — คำนวณแบบ exact แล้วตรวจซ้ำได้ offline':'your "B beats A" decision rests on a finite set of measurements. How many would an adversary have to corrupt (to any value within the observed range) before the verdict flips? That exact tamper-distance is computed and re-verifiable offline')+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel((th?'gain ชัด ข้อมูลสะอาด':'a strong, clean gain'),j.strong,(th?'รอดแม้โดนปลอมหลายจุด':'survives many corrupted points'))
+panel((th?'gain ก้ำกึ่ง จม noise':'a marginal gain in noise'),j.marginal,(th?'จุดเดียวพลิกได้':'a single bad point flips it'))
+'</div><div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'ยิ่งเลขสูง ยิ่งเชื่อถือได้ · พิสูจน์แบบสร้างได้: แนบ "การโจมตีจริง" ที่ทำให้พลิก ตรวจซ้ำเองได้':'a higher number is a decision you can stand behind · constructive: the cert ships the exact attack that flips it — re-apply it yourself')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองระยะทนการปลอมข้อมูล':'DECISION-BREAKDOWN CERTIFICATE'),(th?'ต้องปลอมข้อมูลกี่จุดผลถึงพลิก — สิ่งที่ LLM ทำไม่ได้':'how much corrupted data until the verdict flips — an LLM cannot'),body,(th?'พิสูจน์แล้ว: ระยะพลิก exact 100% · แนบ witness ที่พลิกจริง 100% · ศัตรูแรงขึ้น(ช่วงกว้างขึ้น) ระยะพลิกไม่เพิ่ม 100% · เลขปลอมถูกจับ 100% · เซ็น Ed25519':'proven: exact breakdown 100% · ships a witness that truly flips it 100% · a stronger (wider-range) adversary never raises the breakdown 100% · forged m caught 100% · Ed25519-signed'));}
function gSel(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังแก้อคติจากการเลือกที่ดีที่สุด…':'de-biasing the winner…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/selection',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7,n:30})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastSel=j;renderSel(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderSel(j){var th=(LANG==='th');var col='#38bdf8';
var bar=function(label,val,c,sub){return '<div style="flex:1;min-width:150px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+label+'</div><div style="font-size:30px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'55;line-height:1">'+val.toFixed(2)+'</div><div style="font-size:11px;color:#8a98b8;margin-top:5px">'+sub+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?('ค้นหา '+j.searched+' การตั้งค่า แล้วรายงานตัวที่ดีที่สุด — แต่เลขนั้น "เฟ้อ" เพราะคุณเลือก max ของการวัดที่มี noise '+j.searched+' ครั้ง. แก้อคติแล้ว: ค่าจริงของผู้ชนะ ≥ ขอบล่างที่แก้แล้ว (เชื่อมั่น '+(j.confidence*100).toFixed(1)+'%)'):('searched '+j.searched+' settings and reported the best — but that number is INFLATED: it is the max of '+j.searched+' noisy trials. De-biased: the winner TRUE value is ≥ the corrected lower bound ('+(j.confidence*100).toFixed(1)+'% confidence)'))+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+bar((th?'ที่รายงานทั่วไป (เฟ้อ)':'naive reported best'),j.naiveBest,'#fbbf24',(th?'max ของ '+j.searched+' ครั้ง':'the max of '+j.searched+' trials'))
+bar((th?'ค่าจริงของผู้ชนะ':'winner TRUE value'),j.trueValueOfWinner,'#94a3b8',(th?'เฟ้อไป +'+j.naiveOverstatedBy:'naive overstated by +'+j.naiveOverstatedBy))
+bar((th?'ขอบล่างที่แก้อคติ':'de-biased lower bound'),j.correctedLowerBound,j.boundIsValid?'#34d399':'#fb7185',(th?'หักโทษการเลือก −'+j.selectionPenalty:'less the selection penalty −'+j.selectionPenalty))
+'</div>'+(j.estimatedSigma?'<div style="margin-top:10px;padding:9px 12px;background:rgba(56,189,248,.07);border:1px solid #38bdf855;border-radius:10px;font-size:12px;color:#cdd6ee">'+(th?('σ <b>ไม่ทราบ</b> → ประมาณจาก '+j.estimatedSigma.replicatesPerCandidate+' ซ้ำ/จุด (df '+j.estimatedSigma.df+', studentized): ขอบล่าง = <b>'+j.estimatedSigma.correctedLowerBound+'</b> — coverage ยังถูกต้อง ที่ plug-in ธรรมดาพัง (เซ็น+ตรวจผ่าน '+(j.estimatedSigma.verified?'✓':'✕')+')'):('σ <b>unknown</b> → estimated from '+j.estimatedSigma.replicatesPerCandidate+' reps/candidate (df '+j.estimatedSigma.df+', studentized): bound = <b>'+j.estimatedSigma.correctedLowerBound+'</b> — coverage holds where a plain plug-in breaks (signed + verified '+(j.estimatedSigma.verified?'✓':'✕')+')'))+'</div>':'')+'<div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'ขอบล่างที่แก้แล้ว ≤ ค่าจริง = '+(j.boundIsValid?'ใช่ ✓ (ขอบเขตถูกต้อง)':'—')+' · ยิ่งค้นห N มาก โทษยิ่งมาก':'corrected bound ≤ the truth = '+(j.boundIsValid?'yes ✓ (a valid bound)':'—')+' · the more settings you search, the larger the discount')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองอคติจากการเลือก (Winner Curse)':'SELECTION-BIAS CERTIFICATE'),(th?'แก้ตัวเลขที่เฟ้อจากการเลือก max — สิ่งที่ LLM ทำไม่ได้':'de-bias the inflated best-of-N — an LLM cannot'),body,(th?'พิสูจน์แล้ว: ขอบล่างถูกต้อง ≥97.5% (วัด 99.5%) · σ ไม่ทราบก็ได้ (studentized, plug-in พังที่ 94.9% เราคุม 99.3%) · โทษโตตาม N · ปลอมถูกจับ · เซ็น Ed25519':'proven: lower bound valid ≥97.5% (measured 99.5%) · works with σ UNKNOWN (studentized: a plain plug-in breaks at 94.9%, we hold 99.3%) · monotone in N · forgery caught · Ed25519-signed'));}
function gSup(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังตรวจว่าคำแนะนำอยู่ในขอบเขตข้อมูล…':'checking whether the recommendation is inside the evidence…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/support',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastSup=j;renderSup(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderSup(j){var th=(LANG==='th');var col='#818cf8';
var COL={'SUPPORTED':'#34d399','SPARSE-INTERIOR':'#fbbf24','EXTRAPOLATION':'#fb7185'};
var LBL=th?{'SUPPORTED':'✓ อยู่ในข้อมูล','SPARSE-INTERIOR':'△ ช่องว่างในกล่อง','EXTRAPOLATION':'✕ นอกขอบเขต (extrapolate)'}:{'SUPPORTED':'✓ SUPPORTED','SPARSE-INTERIOR':'△ SPARSE-INTERIOR','EXTRAPOLATION':'✕ EXTRAPOLATION'};
var panel=function(p){var c=COL[p.verdict]||'#94a3b8';var wit='';if(p.witness&&p.witness.length){var ws=p.witness.map(function(w){return (th?'ปุ่ม#':'knob #')+w.knob+': '+(th?'ขอ ':'asked ')+w.asked+' ('+(w.side==='above'?'>':'<')+' '+(th?'ค่าสูงสุด/ต่ำสุดที่วัด ':'sampled limit ')+w.sampledLimit+')';}).join(' · ');wit='<div style="font-size:11px;color:#fbbf24;margin-top:8px;font-family:ui-monospace,monospace;line-height:1.5">'+(th?'พยานแยกแกน: ':'separating axis: ')+ws+'</div>';}else if(p.hullWitness){wit='<div style="font-size:11px;color:#fbbf24;margin-top:8px;font-family:ui-monospace,monospace;line-height:1.5">'+(th?'พยานแยกระนาบ (ทุกทิศ): ทิศ ':'separating hyperplane: dir ')+'['+p.hullWitness.direction.join(', ')+'] '+(th?'มาร์จิน ':'margin ')+p.hullWitness.margin+'</div>';}return '<div style="flex:1;min-width:200px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+p.label+'</div><div style="font-size:13px;font-family:ui-monospace,monospace;color:#cdd6ee">x* = ['+p.recommended.join(', ')+']</div><div style="font-size:16px;font-weight:800;color:'+c+';margin-top:9px">'+(LBL[p.verdict]||p.verdict)+'</div><div style="font-size:11px;color:#8a98b8;margin-top:4px">'+(th?'อัตราส่วนระยะใกล้สุด ':'support ratio ')+p.supportRatio+'</div>'+wit+'</div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?('สุ่มวัด '+j.designSize+' จุด. ตรวจคำแนะนำ 4 แบบว่าอยู่ "ในหลักฐาน" หรือเป็นการเดานอกข้อมูล — ตัวที่อยู่นอกกล่อง (พยานแยกแกน) และตัวที่อยู่ในกล่องแต่นอก convex hull (พยานแยกระนาบทุกทิศ) ถูกพิสูจน์ว่าอยู่นอกหลักฐานแน่นอน'):('a design of '+j.designSize+' measured settings. Four recommendations are checked for whether they sit INSIDE the evidence — both an out-of-box point (axis witness) AND an in-box-but-off-the-hull point (a general separating-hyperplane witness) are exactly proven outside the convex hull'))+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel(j.insideCluster)+panel(j.interiorVoid)+panel(j.beyondBox)+(j.offHull?panel(j.offHull):'')
+'</div><div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'อย่าเชื่อคำแนะนำที่อยู่นอกหลักฐาน · พยานตรวจซ้ำเองได้ (ใบรับรองพก design มาเองครบ)':'never trust a recommendation outside the evidence · the witness re-checks offline (the cert carries its own design)')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองขอบเขตข้อมูล (Extrapolation-Guard)':'EXTRAPOLATION-GUARD CERTIFICATE'),(th?'คำแนะนำอยู่ในข้อมูลหรือเดาเอา — สิ่งที่ LLM ทำไม่ได้':'is the recommendation supported or a guess — an LLM cannot'),body,(th?'พิสูจน์แล้ว: นอกกล่อง→extrap 100% (พยานแกน) · ในกล่องแต่นอก hull→extrap 100% (พยานระนาบทุกทิศ, แกนเดิมจับไม่ได้) · ไม่เคย false-flag จุดในข้อมูล · ปลอม SUPPORTED ถูกจับ · เซ็น Ed25519':'proven: out-of-box → EXTRAPOLATION 100% (axis witness) · in-box-but-off-hull → EXTRAPOLATION 100% (general hyperplane, which the axis test misses) · never false-flags an in-data point · a fake SUPPORTED is caught · Ed25519-signed'));}
function gFdr(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังคุมอัตราการค้นพบเท็จ…':'controlling the false-discovery rate…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/fdr',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:4})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastFdr=j;renderFdr(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderFdr(j){var th=(LANG==='th');var col='#2dd4bf';
var bar=function(title,findings,falseOnes,c,note){return '<div style="flex:1;min-width:200px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:30px;font-weight:800;color:#e6edff;line-height:1">'+findings+'</div><div style="font-size:11px;color:#8a98b8;margin-top:3px">'+(th?'รายการที่รายงาน':'findings reported')+'</div><div style="font-size:15px;font-weight:800;color:'+c+';margin-top:9px">'+falseOnes+' '+(th?'เป็นของปลอม (โชคล้วนๆ)':'are false (pure luck)')+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?('ทดสอบ '+j.tested+' สมมุติฐานพร้อมกัน ('+j.realEffects+' อันมีผลจริง ที่เหลือเป็น noise). ถ้าคัดที่ p<'+j.naiveAlpha+' ต่ออัน จะมีของปลอมหลุดมาด้วย. Benjamini-Hochberg คุม "สัดส่วนการค้นพบที่เป็นเท็จ" ให้ ≤ '+(j.targetFDR*100).toFixed(0)+'%'):('testing '+j.tested+' hypotheses at once ('+j.realEffects+' real, the rest noise). Calling each significant at p<'+j.naiveAlpha+' lets false ones through. Benjamini-Hochberg controls the FRACTION of your reported discoveries that are false to ≤ '+(j.targetFDR*100).toFixed(0)+'%'))+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+bar((th?'คัดแบบ naive (p<'+j.naiveAlpha+')':'naive (p<'+j.naiveAlpha+')'),j.naive.findings,j.naive.falseOnes,'#fb7185',(th?'ไม่คุม multiplicity → ของปลอมปนมา':'no multiplicity control → false ones slip in'))
+bar((th?'คุมด้วย BH (FDR ≤ '+(j.targetFDR*100).toFixed(0)+'%)':'BH-controlled (FDR ≤ '+(j.targetFDR*100).toFixed(0)+'%)'),j.bh.discoveries,j.bh.falseOnes,'#34d399',(th?'ตัด '+j.droppedAsLikelyFalse+' รายการที่น่าจะปลอมทิ้ง':'dropped '+j.droppedAsLikelyFalse+' likely-false findings'))
+(j.by?bar((th?'BY — กันได้ทุกแบบ dependence':'BY — any-dependence safe'),j.by.discoveries,j.by.falseOnes,'#818cf8',(th?'หาร q ด้วย H_m='+j.by.harmonic+' (ปลอดภัยแม้ test สัมพันธ์กัน)':'q ÷ H_m='+j.by.harmonic+' (safe even when tests are correlated)')):'')
+'</div>'+(j.qValuesOfDiscoveries&&j.qValuesOfDiscoveries.length?'<div style="margin-top:10px;font-size:11.5px;color:#9fb0d0;font-family:ui-monospace,monospace">'+(th?'q-value ต่อรายการ (ปรับแล้ว ใช้ที่ threshold ไหนก็ได้): ':'per-finding q-values (adjusted, usable at any threshold): ')+j.qValuesOfDiscoveries.join(' · ')+' …</div>':'')+'<div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'BH ตัดของใต้ขีด '+j.bh.threshold+' ทิ้ง · แต่ละผลมี q-value ของตัวเอง · BY กันได้แม้ test สัมพันธ์กัน · ตรวจซ้ำ offline':'BH cut above the '+j.bh.threshold+' cutoff · each finding carries its own q-value · BY stays safe even under correlated tests · re-checkable offline')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองคุมการค้นพบเท็จ (FDR)':'FALSE-DISCOVERY CERTIFICATE'),(th?'รายงานหลายอย่างพร้อมกันโดยคุมของปลอม — สิ่งที่ LLM ทำไม่ได้':'report many findings while controlling the false ones — an LLM cannot'),body,(th?'พิสูจน์แล้ว: BH คุม FDP ≤ q (วัด 7.6%) · naive พุ่ง 13% · q-value ต่อรายการ ตรงกับ BH ทุก threshold · BY กันได้ทุก dependence (ρ=.5 → 1.6%≤q) · เซ็น Ed25519':'proven: BH holds FDP ≤ q (measured 7.6%) · naive inflates to 13% · per-hypothesis q-values match BH at every threshold · BY safe under ANY dependence (ρ=.5 → 1.6%≤q) · Ed25519-signed'));}
function gAny(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังทดสอบแบบ peek ได้ตลอด (anytime-valid)…':'running the anytime-valid (peek-freely) test…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/anytime',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastAny=j;renderAny(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderAny(j){var th=(LANG==='th');var col='#facc15';var rg=j.realGain||{};var nc=j.nullContrast||{};
var bar=function(title,pct,c,note){return '<div style="flex:1;min-width:200px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:32px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'55;line-height:1">'+pct+'%</div><div style="font-size:11px;color:#8a98b8;margin-top:4px">'+(th?'อัตราเตือนผิด (ภายใต้ null, peek ทุกก้าว)':'false-alarm rate (under null, peeking every step)')+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?('AI agent วัดทีละครั้งแล้ว "แอบดู" ทุกครั้ง. ถ้าหยุดตอน p<0.05 → เตือนผิดบ่อยมาก. e-value (มาร์ติงเกล + อสมการ Ville) ทำให้ "หยุดเมื่อไรก็ได้ peek กี่ครั้งก็ได้" การรับประกัน error ยังอยู่. ด้านล่าง: gain จริง μ=0.3 ตรวจเจอ + เทียบอัตราเตือนผิดใต้ null'):('an AI agent measures one at a time and PEEKS every time. Stop at p<0.05 and you false-alarm constantly. The e-value test (a martingale + Ville inequality) stays valid under unlimited peeks + optional stopping. Below: a real gain μ=0.3 is detected + the false-alarm rates under the null compared'))+'</div>'
+'<div style="background:rgba(250,204,21,.07);border:1px solid #facc1555;border-radius:12px;padding:12px 14px;margin-bottom:10px;font-size:13px;color:#cdd6ee">'+(th?'gain จริง (μ=0.3): ':'a real gain (μ=0.3): ')+'<b style="color:'+(rg.verdict==='ANYTIME-SIGNIFICANT'?'#34d399':'#fbbf24')+'">'+(rg.verdict==='ANYTIME-SIGNIFICANT'?(th?'พบนัยสำคัญที่ peek ที่ '+rg.stoppedAt:'significant at peek '+rg.stoppedAt):(th?'ยังสรุปไม่ได้':'inconclusive'))+'</b> · e-value '+rg.eValueAtStop+' ≥ '+rg.threshold+' · '+(th?'ตรวจซ้ำ ':'verified ')+(rg.verified?'✓':'✕')+(rg.ciLower!=null?'<br><span style="font-family:ui-monospace,monospace;color:#9fb0d0">'+(th?'ช่วงเชื่อมั่นแบบ anytime (ใช้ได้ทุกเวลา): ':'anytime confidence sequence (valid at all times): ')+'gain ∈ ['+rg.ciLower+', '+rg.ciUpper+']'+(rg.excludesZero?(th?' — ไม่คร่อม 0 ✓':' — excludes 0 ✓'):'')+'</span>':'')+'</div>'
+'<div style="display:flex;gap:12px;flex-wrap:wrap">'
+bar((th?'e-value (anytime-valid)':'e-value (anytime-valid)'),nc.anytimeFalsePositivePct,'#34d399',(th?'≤ α — peek เท่าไรก็ปลอดภัย':'≤ α — safe no matter how often you peek'))
+bar((th?'naive p<0.05 (peek ทุกก้าว)':'naive p<0.05 (peek every step)'),nc.naivePeekFalsePositivePct,'#fb7185',(th?'พุ่งเกิน α มหาศาล':'blows far past α'))
+'</div><div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'หยุดเมื่อไรก็ได้ การรับประกันยังอยู่ ('+nc.trials+' การทดลอง, peek '+nc.peeks+' ครั้ง/อัน) · ของจริงจาก /anytime':'stop whenever — the guarantee holds ('+nc.trials+' trials, '+nc.peeks+' peeks each) · live from /anytime')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรอง Anytime-Valid (e-value)':'ANYTIME-VALID CERTIFICATE (e-value)'),(th?'แอบดูได้ตลอด การรับประกัน error ยังอยู่ — สิ่งที่ LLM ทำไม่ได้':'peek as often as you like, the guarantee holds — an LLM cannot'),body,(th?'พิสูจน์แล้ว: FP ≤ α (วัด 2.4%) vs naive 42% · + ช่วงความเชื่อมั่นแบบ anytime คุม true gain ทุกเวลาพร้อมกัน 97.4% (naive per-peek เหลือ 58%) · กระชับขึ้นเรื่อยๆ · เซ็น Ed25519':'proven: FP ≤ α (measured 2.4%) vs naive 42% · PLUS a time-uniform confidence sequence covering the true gain at ALL times at once 97.4% (naive per-peek only 58%) · it tightens as evidence accrues · Ed25519-signed'));}
function gSwarm(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังรวมหลักฐานจากหลาย agent…':'pooling evidence across agents…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/swarm',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastSwarm=j;renderSwarm(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderSwarm(j){var th=(LANG==='th');var col='#22d3ee';
var chip=function(v,sig){var c=sig?'#34d399':'#8a98b8';return '<code style="background:rgba(255,255,255,.05);border:1px solid '+c+'44;border-radius:6px;padding:1px 6px;margin:2px;display:inline-block;font-size:11.5px;color:'+c+'">'+v+'</code>';};
var singles=(j.singleAgentEValues||[]).map(function(e){return chip('E='+e,e>=j.threshold);}).join(' ');
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?('AI agent '+j.agents+' ตัว แต่ละตัวมีหลักฐานน้อย (e-value ต่อตัวด้านล่าง). รวมหลักฐานแบบถูกต้องทางสถิติ → แรงกว่าทุกตัวเดี่ยว. และ agent ที่ "โกหก" (อ้าง e-value เกินข้อมูล) ถูกคำนวณซ้ำแล้วคัดออก'):('a swarm of '+j.agents+' agents, each with weak individual evidence (per-agent e-values below). Pooled the statistically-correct way → stronger than any single one. And an agent that LIES (claims more than its data shows) is re-derived and excluded'))+'</div>'
+'<div style="margin-bottom:10px;font-size:12px;color:#9fb0d0">'+(th?'e-value แต่ละ agent (เขียว= ผ่านเดี่ยว): ':'per-agent e-values (green = significant alone): ')+singles+'</div>'
+'<div style="display:flex;gap:12px;flex-wrap:wrap">'
+'<div style="flex:1;min-width:200px;background:rgba(255,255,255,.04);border:1px solid '+(j.anySingleSignificant?'#34d39955':'#fb718555')+';border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+(th?'agent เดี่ยว':'any single agent')+'</div><div style="font-size:20px;font-weight:800;color:'+(j.anySingleSignificant?'#34d399':'#fb7185')+'">'+(j.anySingleSignificant?(th?'✓ มีตัวที่ผ่าน':'✓ one crossed'):(th?'✕ ไม่มีตัวไหนผ่าน':'✕ none significant'))+'</div></div>'
+'<div style="flex:1;min-width:200px;background:rgba(34,211,238,.07);border:1px solid #22d3ee55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+(th?'รวมทั้ง swarm':'pooled swarm')+'</div><div style="font-size:20px;font-weight:800;color:'+(j.verdict==='COMBINED-SIGNIFICANT'?'#34d399':'#fbbf24')+'">'+(j.verdict==='COMBINED-SIGNIFICANT'?(th?'✓ พบนัยสำคัญ':'✓ SIGNIFICANT'):(th?'— ยังไม่พอ':'— inconclusive'))+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:5px">e-value '+j.combinedEValue+' ≥ '+j.threshold+'</div></div>'
+'<div style="flex:1;min-width:200px;background:rgba(255,255,255,.04);border:1px solid #fb718555;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+(th?'agent โกหก':'the lying agent')+'</div><div style="font-size:20px;font-weight:800;color:'+(j.liarExcluded?'#34d399':'#fb7185')+'">'+(j.liarExcluded?(th?'✓ ถูกคัดออก':'✓ excluded'):(th?'✕ หลุดเข้า':'✕ admitted'))+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:5px">'+(th?'นับ honest '+j.honestCount+' · คัดออก '+j.excludedCount:j.honestCount+' honest · '+j.excludedCount+' excluded')+'</div></div>'
+'</div>'+(j.consensus?'<div style="margin-top:10px;padding:9px 12px;background:rgba(34,211,238,.06);border:1px solid #22d3ee44;border-radius:10px;font-size:12px;color:#cdd6ee">'+(th?'ฉันทามติ (agents เห็นตรงกันไหม?): ':'consensus (do the agents agree?): ')+'<b style="color:'+(j.consensus==='HOMOGENEOUS'?'#34d399':'#fb7185')+'">'+(j.consensus==='HOMOGENEOUS'?(th?'เห็นตรงกัน — เชื่อ pool ได้':'HOMOGENEOUS — pool trustworthy'):'HETEROGENEOUS')+'</b> · I²='+j.iSquared+(j.rogueScenario?'<br>'+(th?'มี agent นอกคอก (วัดคนละผล): ':'with a rogue agent (different effect): ')+'<b style="color:#fb7185">'+j.rogueScenario.consensus+'</b> '+(th?'ระบุว่าเป็น ':'pinned to ')+'<code style="color:#fbbf24">'+j.rogueScenario.mostHeterogeneousAgent+'</code> '+(th?'— pool บอก '+j.rogueScenario.pooledVerdict+' แต่ฉันทามติเตือนว่าน่าสงสัย':'— the pool says '+j.rogueScenario.pooledVerdict+' but consensus flags it suspect'):'')+'</div>':'')+'<div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'หลาย agent รวมกัน เห็นสิ่งที่ตัวเดียวไม่เห็น · agent โกหก/นอกคอก จับได้ · ตรวจซ้ำ '+(j.verified?'✓':'✕'):'the swarm sees what no single agent could · a liar OR a disagreeing agent is caught · verified '+(j.verified?'✓':'✕'))+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองหลักฐานรวมหมู่ (Swarm)':'SWARM-EVIDENCE CERTIFICATE'),(th?'รวมหลักฐานหลาย agent อย่างเชื่อถือได้ ทนต่อ agent โกหก — สิ่งที่ LLM ทำไม่ได้':'pool many agents trustworthily, robust to a liar — an LLM cannot'),body,(th?'พิสูจน์แล้ว: รวมหมู่เจอ weak gain 61% (เดี่ยว 29%) · null ≤ α · agent โกหก 10⁶× คัดออก 100% · + เช็คฉันทามติ (Cochran Q): เห็นตรงกัน false-flag 2.8% / agent นอกคอกจับได้+ระบุตัว 100% · เซ็น Ed25519':'proven: pooling detects a weak gain 61% (single 29%) · null ≤ α · a liar inflating 10⁶× excluded 100% · PLUS a consensus check (Cochran Q): agreement false-flagged 2.8% / a disagreeing agent detected + named 100% · Ed25519-signed'));}
function gConf(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังสร้างช่วงทำนายแบบ distribution-free…':'building a distribution-free prediction interval…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/conformal',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastConf=j;renderConf(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderConf(j){var th=(LANG==='th');var col='#a3e635';var tc=j.targetCoverage*100;
var card=function(label,cov,w,note){var onTarget=Math.abs(cov*100-tc)<1.5;var c=onTarget?'#34d399':'#fbbf24';return '<div style="flex:1;min-width:200px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+label+'</div><div style="font-size:30px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'55;line-height:1">'+(cov*100).toFixed(1)+'%</div><div style="font-size:11px;color:#8a98b8;margin-top:3px">'+(th?'coverage จริง (เป้า '+tc.toFixed(0)+'%)':'actual coverage (target '+tc.toFixed(0)+'%)')+'</div><div style="font-size:13px;font-weight:700;color:#cdd6ee;margin-top:8px">'+(th?'กว้าง ±':'width ±')+w+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:6px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?('ข้อมูล residual แบบเบ้ (skewed). "ŷ ± 1.96σ" สมมติ noise เป็นปกติ — ผิด. Conformal ให้ช่วงที่ "การันตี coverage ≥ '+tc.toFixed(0)+'%" โดยไม่สมมติการแจกแจง (exact ระดับ finite-sample จาก '+j.calibrationN+' จุด calibration)'):('skewed residuals. "ŷ ± 1.96σ" assumes Gaussian noise — wrong here. Conformal gives an interval with GUARANTEED coverage ≥ '+tc.toFixed(0)+'% making NO distributional assumption (finite-sample exact from '+j.calibrationN+' calibration points)'))+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+card((th?'Conformal (distribution-free)':'Conformal (distribution-free)'),j.conformal.coverage,j.conformal.halfWidth,(th?'ตรงเป้า + แคบกว่า · band ['+(j.conformal.coverageBand[0]*100).toFixed(1)+'%,'+(j.conformal.coverageBand[1]*100).toFixed(1)+'%]':'on-target + tighter · band ['+(j.conformal.coverageBand[0]*100).toFixed(1)+'%,'+(j.conformal.coverageBand[1]*100).toFixed(1)+'%]'))
+card((th?'Gaussian ±1.645σ':'Gaussian ±1.645σ'),j.gaussian.coverage,j.gaussian.halfWidth,(th?'over-cover + กว้างเกิน '+j.conformalTighterBy+'% (สมมติปกติผิด)':'over-covers + '+j.conformalTighterBy+'% wider (normality assumption wrong)'))
+'</div>'+(j.adaptive?'<div style="margin-top:10px;padding:9px 12px;background:rgba(163,230,53,.06);border:1px solid #a3e63544;border-radius:10px;font-size:12px;color:#cdd6ee">'+(th?'noise ขึ้นกับ input σ(x)=1+2x — plain ครอบคลุมไม่ทั่ว: ง่าย ':'input-dependent noise σ(x)=1+2x — plain is unbalanced: easy ')+'<b style="color:#fbbf24">'+(j.adaptive.plainCoverage.easyRegion*100).toFixed(0)+'%</b> / '+(th?'ยาก ':'hard ')+'<b style="color:#fb7185">'+(j.adaptive.plainCoverage.hardRegion*100).toFixed(0)+'%</b> '+(th?'(ยากครอบคลุมต่ำ=อันตราย)':'(hard region under-covered=dangerous)')+'<br>'+(th?'normalized (ปรับตามความยาก): ง่าย ':'normalized (scales by difficulty): easy ')+'<b style="color:#34d399">'+(j.adaptive.normalizedCoverage.easyRegion*100).toFixed(0)+'%</b> / '+(th?'ยาก ':'hard ')+'<b style="color:#34d399">'+(j.adaptive.normalizedCoverage.hardRegion*100).toFixed(0)+'%</b> '+(th?'— สมดุล':'— balanced')+'</div>':'')+'<div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'การันตีไม่ขึ้นกับการแจกแจง · ปรับช่วงตามความยากของ input · ['+j.conformal.interval[0]+', '+j.conformal.interval[1]+'] · ตรวจซ้ำ '+(j.verified?'✓':'✕'):'a guarantee that needs no distribution · adapts to input difficulty · ŷ±q = ['+j.conformal.interval[0]+', '+j.conformal.interval[1]+'] · verified '+(j.verified?'✓':'✕'))+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรอง Conformal Prediction':'CONFORMAL-PREDICTION CERTIFICATE'),(th?'ช่วงทำนายที่การันตี coverage โดยไม่สมมติการแจกแจง — สิ่งที่ LLM ทำไม่ได้':'a prediction interval with guaranteed coverage, no assumption — an LLM cannot'),body,(th?'พิสูจน์แล้ว: coverage ≥1−α ทุกการแจกแจง · finite-sample exact (n=20) · แคบกว่า Gaussian 22% บน skew · + โหมด adaptive: noise ขึ้นกับ input → plain ครอบคลุมจุดยากแค่ 83% แต่ normalized สมดุล 90%/90% · เซ็น Ed25519':'proven: coverage ≥1−α across every law · finite-sample exact (n=20) · 22% tighter than Gaussian on skew · + adaptive mode: under input-dependent noise plain covers the hard region only 83% while normalized balances 90%/90% · Ed25519-signed'));}
function mcpCall(method,params){return fetch('/mcp',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({jsonrpc:'2.0',id:1,method:method,params:params})}).then(function(r){return r.json();});}
function gMcp(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังเรียก Melete ผ่าน MCP เหมือน AI agent…':'calling Melete over MCP, like an AI agent would…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
mcpCall('initialize',{}).then(function(init){return mcpCall('tools/list',{}).then(function(list){return mcpCall('tools/call',{name:'melete.fdr',arguments:{zScores:[4.2,3.8,3.5,0.2,0.1,3.9],q:0.1}}).then(function(call){return fetch('/mcp/usage',{method:'POST',headers:{'content-type':'application/json'},body:'{}'}).then(function(r){return r.json();}).then(function(usage){window.__lastMcp={init:init,list:list,call:call,usage:usage};renderMcp(window.__lastMcp);});});});}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderMcp(j){var th=(LANG==='th');var col='#f472b6';
var srv=(j.init.result&&j.init.result.serverInfo)||{};var tools=(j.list.result&&j.list.result.tools)||[];var sc=(j.call.result&&j.call.result.structuredContent)||{};var cert=sc.certificate||{};
var toolList=tools.map(function(t){return '<code style="background:rgba(255,255,255,.06);border:1px solid #ffffff14;border-radius:6px;padding:1px 6px;margin:2px;display:inline-block;font-size:11.5px;color:#cdd6ee">'+t.name+'</code>';}).join(' ');
var step=function(n,title,bodyHtml){return '<div style="background:rgba(255,255,255,.04);border:1px solid #ffffff14;border-radius:12px;padding:12px 14px;margin-bottom:8px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:5px">'+n+' · '+title+'</div>'+bodyHtml+'</div>';};
var body=''
+step('1',(th?'จับมือ (initialize)':'handshake (initialize)'),'<div style="font-size:13px;color:#cdd6ee;font-family:ui-monospace,monospace">server = '+(srv.name||'?')+' · MCP '+(srv.version||'?')+'</div>')
+step('2',(th?'เครื่องมือที่ agent เรียกได้':'tools an agent can call'),'<div>'+toolList+'</div>')
+step('3',(th?'agent เรียก melete.fdr แล้วได้ "ใบรับรองที่เซ็นแล้ว" กลับ':'an agent calls melete.fdr → gets a SIGNED certificate back'),'<div style="font-size:12.5px;color:#cdd6ee;font-family:ui-monospace,monospace;line-height:1.6">'+(cert.standard||'?')+'<br>'+(th?'ค้นพบ ':'discoveries ')+(cert.discoveryCount!=null?cert.discoveryCount:'?')+' · '+(th?'ตรวจสอบแล้ว ':'verified ')+'<b style="color:'+(sc.verified?'#34d399':'#fb7185')+'">'+(sc.verified?'✓ true':'✕')+'</b><br><span style="color:#8a98b8">sig '+((cert.signature||'').slice(0,28))+'…</span></div>');
var us=(j.usage)||{};var ug=us.usage||{};
if(j.usage)body+=step('4',(th?'ด่านเก็บค่าผ่านทาง: ทุกการเรียกถูกนับ + เซ็นเป็น audit trail':'the toll-booth: every call metered + signed into an audit trail'),'<div style="font-size:12.5px;color:#cdd6ee;font-family:ui-monospace,monospace;line-height:1.6">'+(th?'เรียกทั้งหมด ':'total calls ')+(ug.total!=null?ug.total:'?')+' · '+(th?'สายโซ่สมบูรณ์ ':'chain intact ')+'<b style="color:'+(us.chainIntact?'#34d399':'#fb7185')+'">'+(us.chainIntact?'✓':'✕')+'</b><br><span style="color:#8a98b8">'+(th?'นับตามเครื่องมือ (ไว้คิดเงินแบบ usage): ':'per-tool tally (usage-based billing): ')+Object.keys(ug.byTool||{}).map(function(k){return k+'×'+ug.byTool[k];}).join(' · ')+'</span></div>');
document.getElementById('flabout').innerHTML=flabShell(col,(th?'MCP — มิดเดิลแวร์แห่งความจริง':'MCP — THE TRUST MIDDLEWARE'),(th?'AI agent ทุกค่ายเรียก Melete แล้วได้คำตอบที่ตรวจสอบเองได้':'any AI agent calls Melete and gets an answer it can verify itself'),body,(th?'กลยุทธ์ unicorn: เป็นชั้นความจริงที่ทุก agent เสียบใช้ (Claude/GPT/Gemini) · ทุกผลเซ็น Ed25519 ตรวจซ้ำ offline · ทุกการเรียกถูกนับ+เซ็นเป็น audit trail (ด่านเก็บเงินแบบ usage) · ของจริงจาก /mcp + /mcp/usage (stdio: melete-mcp)':'the unicorn play: be the trust layer every agent plugs into (Claude/GPT/Gemini) · every result Ed25519-signed + re-checkable offline · every call metered + signed into an audit trail (usage-based toll-booth) · live from /mcp + /mcp/usage (stdio: melete-mcp)'));}
function gImp(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังพิสูจน์การปรับปรุง…':'proving the improvement…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/improvement',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:7})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastImp=j;renderImp(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderImp(j){var th=(LANG==='th');var col='#fb923c';
var panel=function(title,p,note){var win=(p.verdict==='IMPROVEMENT');var c=win?'#34d399':'#fbbf24';return '<div style="flex:1;min-width:220px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:30px;font-weight:800;color:#e6edff">'+p.measurements+'</div><div style="font-size:11px;color:#8a98b8;margin-top:-2px">'+(th?'การวัด':'measurements')+'</div><div style="font-size:16px;font-weight:800;color:'+c+';margin-top:8px">'+(win?(th?'✓ ดีขึ้น ≥ +':'✓ IMPROVEMENT ≥ +')+p.certifiedGain:(th?'— สรุปไม่ได้ (จม noise)':'— INCONCLUSIVE (lost in noise)'))+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var ratio=(j.independent.measurements&&j.paired.measurements)?(j.independent.measurements/j.paired.measurements).toFixed(1):'—';
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?'กระบวนการที่มี noise ร่วม (เช่น ผลของวัน/แบตช์). วัด A กับ B แบบจับคู่ใต้ noise ก้อนเดียวกัน (common random numbers) → noise หักกันในส่วนต่าง → รับรอง gain เดิมด้วยการวัดน้อยกว่ามาก':'a process with shared noise (a day/batch effect). Measuring A and B PAIRED under the same draw (common random numbers) cancels that noise in the difference — certifying the same gain from far fewer measurements')+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel((th?'วัดแยกอิสระ':'independent measurement'),j.independent,(th?'noise ร่วมยังอยู่ → ต้องวัดเยอะ':'shared noise remains → needs many'))
+panel((th?'จับคู่ CRN':'common-random-numbers pairing'),j.paired,(th?'noise หักกัน → รับรองด้วยการวัดน้อย':'noise cancels → certified from few'))
+(j.sequential?panel((th?'หยุดอัตโนมัติ (sequential)':'sequential early-stop'),j.sequential,(th?'หยุดทันทีที่รับรองได้ (จาก '+j.sequential.vsFixed+' คงที่) · Bonferroni':'stops the moment it certifies (vs '+j.sequential.vsFixed+' fixed) · Bonferroni')):'')
+'</div><div style="margin-top:10px;font-size:13px;color:#2dd4bf;font-weight:700">→ '+(th?'gain เดียวกัน ใช้การวัดน้อยลง '+ratio+'× ด้วย CRN'+(j.sequential?(' · sequential หยุดที่ '+j.sequential.measurements+' จาก '+j.sequential.vsFixed):'')+' (แต่ละการวัด = เงิน/reagent)':'same gain, '+ratio+'× fewer with CRN'+(j.sequential?(' · sequential stops at '+j.sequential.measurements+' of '+j.sequential.vsFixed):'')+' (each measurement = reagents / money)')+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบพิสูจน์การปรับปรุง':'PROOF OF IMPROVEMENT'),(th?'รับรอง gain ด้วยการวัดน้อยลงหลายเท่า':'certify the gain from far fewer measurements'),body,(th?'พิสูจน์แล้ว: CRN ~8.8× · sequential หยุดเร็ว ~1.9× (วัดเฉลี่ย 41.9 จาก 80) · ขอบล่างถูกต้อง ≥97.5% · false-cert ≤2.5% · เซ็น Ed25519':'proven: CRN ~8.8× · sequential early-stop ~1.9× (avg 41.9 of 80) · lower bound valid ≥97.5% · false-cert ≤2.5% · Ed25519-signed'));}
function gTol(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังรับรองช่วงทนทาน…':'certifying the tolerance…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
var go=function(sc){return fetch('/tolerance',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({scenario:sc})}).then(function(r){return r.json();});};
Promise.all([go('broad'),go('narrow')]).then(function(arr){if(arr[0].error||arr[1].error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+(arr[0].error||arr[1].error)+'</div>';return;}window.__lastTol=arr;renderTol(arr[0],arr[1]);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderTol(broad,narrow){var th=(LANG==='th');var col='#2dd4bf';
var panel=function(title,j,note){var c=col;return '<div style="flex:1;min-width:220px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:26px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'66">±'+j.radiusPctOfRange+'%</div><div style="font-size:12px;color:#8a98b8;margin-top:4px">'+(th?'รับประกัน ≥ ':'guaranteed ≥ ')+Math.round(j.floorFraction*100)+'% '+(th?'ของ optimum':'of the optimum')+' · '+(j.verified?(th?'✓ ตรวจแล้ว':'✓ verified'):'…')+'</div><div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?'ช่วงที่ "เพี้ยนได้" ทุกปุ่มแล้วยังเก็บ ≥90% ของ optimum — รับประกันกรณีเลวร้ายสุดด้วย Lipschitz (กันค่าระหว่างจุด grid ด้วย) ไม่ใช่แค่ค่าเฉลี่ย':'how far every knob can drift and still keep ≥90% of the optimum — a worst-case Lipschitz guarantee (covers between-grid points too), not an average')+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel((th?'ยอดกว้าง (ทนทาน)':'a broad peak (forgiving)'),broad,(th?'ได้ tolerance กว้าง → ผลิตจริงง่าย':'a wide guaranteed tolerance → easy to hold in production'))
+panel((th?'ยอดแคบ (เปราะ)':'a narrow peak (fragile)'),narrow,(th?'tolerance แคบ → ต้องคุมเข้ม':'a tight tolerance → must be controlled precisely'))
+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองช่วงทนทาน':'TOLERANCE CERTIFICATE'),(th?'รับประกันกรณีเลวร้ายสุด ±r':'a certified worst-case ±r'),body,(th?'พิสูจน์แล้ว 8400/8400 จุด off-grid ไม่หลุดพื้น · Lipschitz-guaranteed · เซ็น Ed25519 · ของจริงจาก /tolerance':'proven: 8400/8400 off-grid samples held the floor · Lipschitz-guaranteed · Ed25519-signed · live from /tolerance'));}
function gHonest(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังออกใบพิสูจน์ + ลองปลอม…':'issuing a proof + forging a fake…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
fetch('/honest-search',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({seed:3})}).then(function(r){return r.json();}).then(function(j){if(j.error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+j.error+'</div>';return;}window.__lastHon=j;renderHonest(j);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderHonest(j){var th=(LANG==='th');var col='#facc15';
var panel=function(title,v,reason,good){var c=good?'#34d399':'#fb7185';return '<div style="flex:1;min-width:220px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:22px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'66">'+(good?'✓ ':'✕ ')+v+'</div><div style="font-size:12px;color:#cdd6ee;margin-top:7px;line-height:1.5">'+reason+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?'engine ค้นหาจริง '+j.evaluations+' ครั้ง → ใบพิสูจน์ที่ "เล่นซ้ำ" ได้. แล้วลองปลอม trace — ผู้ตรวจ replay engine กับค่าที่บันทึก (ไม่ต้องมี oracle)':'a real search of '+j.evaluations+' evaluations → a re-derivable proof. Then we forge the trace — the auditor replays the engine against the recorded values (no oracle needed)')+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel((th?'ค้นหาจริง':'a genuine search'),(th?'ของจริง':'GENUINE'),(th?'trace เล่นซ้ำตรงเป๊ะใต้ engine — เชื่อได้':'the trace re-derives exactly under the engine — trustworthy'),j.genuine.verdict==='GENUINE')
+panel((th?'ของปลอม (เหมือน LLM แต่งคำตอบ)':'a forgery (a faked “optimization”)'),(th?'ปฏิเสธ':'REJECTED'),j.forged.reason,false)
+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบพิสูจน์การค้นหาจริง':'HONEST-SEARCH PROOF'),(th?'จับการ optimize ปลอม — สิ่งที่ LLM ทำไม่ได้':'detect a faked optimization — an LLM cannot'),body,(th?'พิสูจน์แล้ว ปลอม 360/360 ถูกจับ · ตรวจ offline ไม่ต้องมี oracle · เซ็น Ed25519 · ของจริงจาก /honest-search':'proven: 360/360 forgeries caught · audited offline, oracle-free · Ed25519-signed · live from /honest-search'));}
function gStab(){var out=document.getElementById('flabout');var th=(LANG==='th');if(out)out.innerHTML='<div class="muted" style="font-size:13px">▶ '+(th?'กำลังรันหลาย start อิสระ…':'running independent searches…')+'</div>';if(out&&out.scrollIntoView)setTimeout(function(){out.scrollIntoView({behavior:'smooth',block:'center'});},150);
var go=function(sc){return fetch('/stability',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({scenario:sc,seed:3})}).then(function(r){return r.json();});};
Promise.all([go('easy'),go('split')]).then(function(arr){if(arr[0].error||arr[1].error){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+(arr[0].error||arr[1].error)+'</div>';return;}window.__lastStab=arr;renderStab(arr[0],arr[1]);}).catch(function(e){if(out)out.innerHTML='<div style="color:#c33;font-size:13px">⚠ '+e.message+'</div>';});}
function renderStab(easy,split){var th=(LANG==='th');var col='#38bdf8';
var panel=function(title,j,note){var stable=(j.verdict==='STABLE');var c=stable?'#34d399':'#fbbf24';var rec=(j.best&&j.best.experiment)?Object.keys(j.best.experiment).map(function(k){return k+'='+(+j.best.experiment[k]).toFixed(2);}).join(' · '):'—';return '<div style="flex:1;min-width:220px;background:rgba(255,255,255,.04);border:1px solid '+c+'55;border-radius:14px;padding:14px 16px"><div style="font-size:11px;letter-spacing:.5px;text-transform:uppercase;color:#9fb0d0;margin-bottom:6px">'+title+'</div><div style="font-size:22px;font-weight:800;color:'+c+';text-shadow:0 0 14px '+c+'66">'+(stable?(th?'✓ เสถียร':'✓ STABLE'):(th?'⚠ ไม่เสถียร':'⚠ UNSTABLE'))+'</div><div style="font-size:12px;color:#8a98b8;margin-top:4px">'+(th?'ฉันทามติ ':'consensus ')+Math.round((+j.consensus)*100)+'% · '+j.replicas+' '+(th?'การค้นหาอิสระ':'searches')+'</div><div style="font-size:12px;color:#cdd6ee;margin-top:7px">'+(th?'จุดที่เจอ: ':'found: ')+'<b>'+rec+'</b></div><div style="font-size:11.5px;color:#8a98b8;margin-top:7px">'+note+'</div></div>';};
var body='<div style="font-size:13px;color:#cdd6ee;margin:2px 2px 12px">'+(th?'รันหลาย start อิสระ แล้ววัดว่าลู่เข้าที่เดียวกันไหม — เสถียร = ทำซ้ำได้ · ไม่เสถียร = ควรค้นหาต่อ':'run several independent searches and measure whether they converge to the same place — stable = reproducible · unstable = keep searching')+'</div><div style="display:flex;gap:12px;flex-wrap:wrap">'
+panel((th?'ปัญหาง่าย (ยอดเดียว)':'an easy problem (one peak)'),easy,(th?'ทุก start ลู่เข้าที่เดียว → เชื่อได้':'all searches agree → trustworthy'))
+panel((th?'ยอดคู่ก้ำกึ่ง (งบน้อย)':'twin near-equal peaks (low budget)'),split,(th?'start แตกกระจาย → Melete เตือนว่ายังไม่นิ่ง':'searches split → Melete warns it is not settled'))
+'</div>';
document.getElementById('flabout').innerHTML=flabShell(col,(th?'ใบรับรองความเสถียร':'STABILITY CERTIFICATE'),(th?'ทำซ้ำได้ไหม ไม่ใช่แค่ฟลุค':'reproducible, or a one-off?'),body,(th?'หลาย start อิสระ (Halton) · พิสูจน์แล้ว STABLE ⇒ ทำซ้ำได้ ≥97.5% · เซ็น Ed25519 · ของจริงจาก /stability':'independent Halton starts · proven STABLE ⇒ reproducible ≥97.5% · Ed25519-signed · live from /stability'));}
...
<p class="muted" style="margin-top:10px">≈ 12 experiments vs ~95 for random to reach 99% of a hidden optimum (≈8×). Reproduce with <code>melete bench</code>.</p></section>
...
function setLang(l){LANG=l;try{localStorage.setItem('mlang',l);}catch(e){}
 ...
 try{if(window.__lastStab&&typeof renderStab==='function')renderStab(window.__lastStab[0],window.__lastStab[1]);}catch(e){}
 try{if(window.__lastHon&&typeof renderHonest==='function')renderHonest(window.__lastHon);}catch(e){}
 try{if(window.__lastTol&&typeof renderTol==='function')renderTol(window.__lastTol[0],window.__lastTol[1]);}catch(e){}
 try{if(window.__lastImp&&typeof renderImp==='function')renderImp(window.__lastImp);}catch(e){}
 try{if(window.__lastPre&&typeof renderPre==='function')renderPre(window.__lastPre);}catch(e){}
 try{if(window.__lastBreak&&typeof renderBreak==='function')renderBreak(window.__lastBreak);}catch(e){}
 try{if(window.__lastSel&&typeof renderSel==='function')renderSel(window.__lastSel);}catch(e){}
 try{if(window.__lastSup&&typeof renderSup==='function')renderSup(window.__lastSup);}catch(e){}
 try{if(window.__lastFdr&&typeof renderFdr==='function')renderFdr(window.__lastFdr);}catch(e){}
 try{if(window.__lastAny&&typeof renderAny==='function')renderAny(window.__lastAny);}catch(e){}
 try{if(window.__lastSwarm&&typeof renderSwarm==='function')renderSwarm(window.__lastSwarm);}catch(e){}
 try{if(window.__lastConf&&typeof renderConf==='function')renderConf(window.__lastConf);}catch(e){}
 try{if(window.__lastMcp&&typeof renderMcp==='function')renderMcp(window.__lastMcp);}catch(e){}
...
<section class="ps">
  ...
  <div class="price">
    ...
    <div class="tier reveal"><div class="tn">Acquisition</div><div class="tp">Acquire</div><div class="tps">the code + the namespace</div><ul><li>Dependency-free TypeScript, 66 modules</li><li>Transfers repo + <code>melete-ai</code> npm</li><li>Live, tested, one-command deploy</li><li>The roadmap + this moat</li></ul><div class="ta"><a class="tb s" href="mailto:patsa2561@gmail.com?subject=Melete%20Acquisition">Make an offer →</a></div></div>
  </div>
