...
describe("gauntlets (every module = 100)", () => {
  ...
  it("🌐 DRO — distribution-shift robustness: χ²-ball worst-case is a valid+tight lower bound, ranks robust over fragile, monotone in ρ, signed", () => expect(droGauntlet().score).toBe(100));
