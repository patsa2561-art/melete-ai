...
describe("gauntlets (every module = 100)", () => {
  ...
  it("🔒 PRIVACY — analytic-Gaussian (ε,δ)-DP: membership attack stays in the privacy region, under-noise caught, composition budget enforced, signed", () => expect(privacyGauntlet().score).toBe(100));
