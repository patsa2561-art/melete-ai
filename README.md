...
| 🪨 **Decision-Breakdown** *(new)* | how many measurements would an adversary (fraud, a glitchy sensor) have to **corrupt to flip** your "B beats A" verdict? The **exact tamper-distance** — a strong clean call survives many corruptions, a marginal one flips on one. *(exact: m flips & m−1 holds 100%; an inflated robustness claim is caught 100%)* |
